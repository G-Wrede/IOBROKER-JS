...
let statesToCreate = [
    //Zeichenkette
    //['Ordner.datenpunktID1', {'name':Name_1', 'type':'string', 'read':true, 'write':true, 'def':'Hello'}],
    //Logikwert
    //['Ordner.datenpunktID1', {'name':Name_1', 'type':'boolean', 'read':true, 'write':true, 'def':'Hello'}],
    //Logikwert mit "Rolle : Info"
    //['Ordner.datenpunktID1', {'name':Name_1', 'type':'boolean', 'read':true, 'write':true, 'role':'info', 'def':'Hello'}],
    //Zahl
    //['Ordner.datenpunktID1', {'name':Name_1', 'type':'number', 'read':true, 'write':true, 'def':'0'}],
    //gemischt
    //['Ordner.datenpunktID1', {'name':Name_1', 'type':'mixed', 'read':true, 'write':true, 'def':'abs123'}],


    //['Teest.Test1', {'name':'Test 1', 'type':'string', 'read':true, 'write':true, 'role':'info', 'def':'Hello' }],
    //['Teest.Test2', {'name':'Test 2', 'type':'string', 'read':true, 'write':true, 'role':'info', 'def':'Hello' }],
    ['Temp1.Test3', {'name':'Test 3', 'type':'string', 'read':true, 'write':true, 'role':'info', 'def':'Hello' }],
];
